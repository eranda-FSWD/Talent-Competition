...
export class IndividualDetailSection extends Component {
  ...
  renderDisplay() {
    ...
    let newFullName = this.props.details && this.props.details;
      ...
      <div className="row">
        <div className="ui sixteen wide column">
          <React.Fragment>
            <p>
              Name:
              {newFullName && newFullName.firstName && newFullName.firstName}
              {newFullName && newFullName.lastName && newFullName.lastName}
            </p>
            <p>Email: {email}</p>
            <p>Phone: {phone}</p>
          </React.Fragment>
