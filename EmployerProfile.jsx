...
export default class EmployeeProfile extends React.Component {
  ...
  loadData() {
    ...
    $.ajax({
      url:
        "https://talent-comp-eranda-pro.azurewebsites.net/profile/profile/getEmployerProfile",
      headers: {
  ...
  saveData() {
    ...
    $.ajax({
      url:
        "https://talent-comp-eranda-pro.azurewebsites.net/profile/profile/saveEmployerProfile",
      headers: {
        Authorization: "Bearer " + cookies,
        "Content-Type": "application/json",
      },
